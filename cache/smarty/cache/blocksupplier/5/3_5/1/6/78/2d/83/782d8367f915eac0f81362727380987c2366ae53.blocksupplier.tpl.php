...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_59b540403ecc40_40434049',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59b540403ecc40_40434049')) {function content_59b540403ecc40_40434049($_smarty_tpl) {?>
	...
	<div class="block_content list-block">
					...
					title="Més sobre Cal Marti">
				                Cal Marti
															...
															<li class="item">
                					<a 
					href="http://botiga-teixitdelaterra.rhcloud.com/ca/18__cal-mateu" 
					title="Més sobre Cal Mateu">
				                Cal Mateu
                					</a>
                				</li>
															<li class="item">
                					<a 
					href="http://botiga-teixitdelaterra.rhcloud.com/ca/9__carns-bayo" 
					title="Més sobre Carns Bayo">
				                Carns Bayo
                					</a>
                				</li>
															<li class="item">
                					<a 
					href="http://botiga-teixitdelaterra.rhcloud.com/ca/27__fem-arrels" 
					title="Més sobre Fem arrels">
				                Fem arrels
                					</a>
                				</li>
																																																																																																					</ul>
					...
					<div class="form-group selector1">
						<select class="form-control" name="supplier_list">
							<option value="0">Tots els proveïdors</option>
													...
													<option value="http://botiga-teixitdelaterra.rhcloud.com/ca/27__fem-arrels">Fem arrels</option>
													<option value="http://botiga-teixitdelaterra.rhcloud.com/ca/25__la-catxaruda">La Catxaruda</option>
													<option value="http://botiga-teixitdelaterra.rhcloud.com/ca/7__la-cleda">La Cleda</option>
													<option value="http://botiga-teixitdelaterra.rhcloud.com/ca/26__la-veganeria">La Veganeria</option>
