...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_59b540400f45a1_57372974',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59b540400f45a1_57372974')) {function content_59b540400f45a1_57372974($_smarty_tpl) {?>
<!-- MODULE Block best sellers -->
<div id="best-sellers_block_right" class="block products_block">
	<h4 class="title_block">
    	<a href="http://botiga-teixitdelaterra.rhcloud.com/ca/best-sales" title="Veieu els productes més venuts">Els més venuts</a>
    </h4>
	<div class="block_content">
			<ul class="block_content products-block">
				...
				<div class="product-content">
					...
					<li class="clearfix">
				<a href="http://botiga-teixitdelaterra.rhcloud.com/ca/la-catxaruda/980-platan-1-2-kg-.html" title="" class="products-block-image content_img clearfix">
					<img class="replace-2x img-responsive" src="http://botiga-teixitdelaterra.rhcloud.com/798-small_default/platan-1-2-kg-.jpg" alt="" />
				</a>
				<div class="product-content">
                	<h5>
                    	<a class="product-name" href="http://botiga-teixitdelaterra.rhcloud.com/ca/la-catxaruda/980-platan-1-2-kg-.html" title="">
                            Plàtan [1/2 Kg]
                        </a>
                    </h5>
                    <p class="product-description"></p>
		...
		<div class="lnk">
        	<a href="http://botiga-teixitdelaterra.rhcloud.com/ca/best-sales" title="Tots els més venuts"  class="btn btn-default button button-small"><span>Tots els més venuts<i class="icon-chevron-right right"></i></span></a>
        </div>
		</div>
</div>
